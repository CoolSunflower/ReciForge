...
Usage: python finetune.py {design_name}
...
# Import your required modules from your existing pipeline.
# Make sure that these files (main.py, visualiser.py, losses.py) are in your PYTHONPATH.
...
# List of pretrained model design names (change these names as appropriate)
...
def main():
    ...
    finetuned_model = train_model(
        ...
        patience=10,
        vis_dir=vis_dir,
        design_name=design_name  # Optional; if your train_model supports printing design name etc.
    )
